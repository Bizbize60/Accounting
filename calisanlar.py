...
class Employee(QWidget):
    ...
    def browsersearch(self):
        def files():
            ...
            self.root.filenames=filedialog.askopenfilenames(initialdir=r"C:\Users\PC\Desktop\Resimler",title="Seç",filetypes=[("All Files","*.*")])
    ...
    def retrieve(self):
        ...
        for i in range (len(results)):
            if results[i]==None or str(results[i]).isnumeric():
                ...
                path="C:/Users/BBS/Desktop/lab/resimler/img{0}.jpg".format(str(i))
